<template>
    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-title v-if="value._links">
            OrderData # {{value._links.self.href.split("/")[value._links.self.href.split("/").length - 1]}}
        </v-card-title >
        <v-card-title v-else>
            OrderData
        </v-card-title >
        ...
        <v-card-text>
            ...
            <Number label="AmountOfPayment" v-model="value.amountOfPayment" :editMode="editMode"/>
        </v-card-text>
        ...
        methods: {
            ...
            async save(){
                try {
                    ...
                    if(!this.offline) {
                        if(this.isNew) {
                            temp = await axios.post(axios.fixUrl('/orderData'), this.value)
                        } else {

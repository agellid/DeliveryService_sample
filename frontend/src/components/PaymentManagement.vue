<template>
    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-title v-if="value._links">
            PaymentManagement # {{value._links.self.href.split("/")[value._links.self.href.split("/").length - 1]}}
        </v-card-title >
        <v-card-title v-else>
            PaymentManagement
        </v-card-title >
        ...
        <v-card-text>
            ...
            <Number label="PayStatus" v-model="value.payStatus" :editMode="editMode"/>
        ...
        methods: {
            ...
            async save(){
                try {
                    ...
                    if(!this.offline) {
                        if(this.isNew) {
                            temp = await axios.post(axios.fixUrl('/paymentManagements'), this.value)
                        } else {

...
pluralCaseList.push( {plural: "paymentManagements", pascal: "PaymentManagement"} )

pluralCaseList.push( {plural: "orderData", pascal: "OrderData"} )

pluralCaseList.push( {plural: "deliveries", pascal: "Delivery"} )

pluralCaseList.push( {plural: "smsMessages", pascal: "SmsMessage"} )
